...
%% in \textit{haskell-wasm}.
%% %
Our testing approach is to assert that, whenever a randomly generated (or
...
%
However, our tool can automatically synthesize all the boilerplate code required
to operate, becoming a drop-in replacement of \quickcheck (the most ubiquitous
RPBT tool in Haskell). 
%     
...
from Coq to Haskell. 
%
Although this translation could be done quite mechanically (this process was
partially aided by Coq's code extraction mechanism), we cannot guarantee that
our Haskell version of the code behaves exactly as the original one. 
%
