...
%
\fuzzchick is a tool coverage-guided, property-based testing (CGPT) tool that
...
used by \citeauthor{lampropoulos2019coverage} on their original work, and a
WebAssembly engine written in Haskell.
%
...
%
This case study also help us comparing the performance our tool against a more
traditional PBT approach that does not rely on code instrumentation.
%
All in all, our evaluation encompass more than 600 hours of computing time and
suggest that testing mutants exhaustively can be an appealing technique for
...
create a stub module which initializes one memory block and exports a single
...
encourage the reader to obtain a color-printed version of this paper.
%
...
written in Haskell.%
\footnote{As meantioned earlier, we foresee no problems into translating our
  tool in other programming languages beyond Haskell.}
%
