...
%
It enhances automatically synthesized generators with type-preserving mutations
guided by execution traces.
%
...
In this work we present \mutagen, a coverage-guided, property-based testing
framework that builds upon the ideas behind \fuzzchick.
%
...
--- some of these already being identified by the authors of \fuzzchick in their
original work.
%
In particular:
%
...
%
This mechanism let us selectively escape the exhaustiveness of our tool by
randomly sampling a small random generator a reduced number of times.
%
...
generator can perform a random uniform choice between generating either a single
leaf or a branch.
%
...
written in Haskell.
%
Despite the choice of implementation language, the ideas presented in this work
extend beyond Haskell and functional programming languages in general.
%
...
account.
%
Moreover, we additionally set a 20ms timeout to discard potentially diverging
