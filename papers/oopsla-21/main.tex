...
the program's AST in case of generating code. Internally, \fuzzchick relies on
execution traces to distinguish which executed test cases were interesting and
are therefore worth mutating --- a popular technique known as
...
%
The techniques behind \fuzzchick are not meant to replace sophisticated,
manually written random generators, but rather providing an adequate testing
solution for early stages of development.
...
%% revised.%
%
The approach taken by \fuzzchick leaves considerable room for improvements in
many aspects\footnote{Some of these were already identified by the authors of
...
\citeauthor{lampropoulos2019coverage} in their original work of \fuzzchick, and a WebAssembly
